...
#pragma config(Motor,  port2,           stl,           tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           sbl,           tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           str,           tmotorVex393TurboSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           sbr,           tmotorVex393TurboSpeed_MC29, openLoop)
